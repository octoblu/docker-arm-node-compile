...
RUN echo '#!/bin/sh' > /bin/sudo && chmod +x /bin/sudo
RUN wget http://archive.raspberrypi.org/debian/pool/main/p/pigpio/pigpio_1.60-1_armhf.deb && dpkg -i pigpio_1.60-1_armhf.deb
